    ...
    <main className="min-h-screen bg-ink px-4 py-6 pb-24 text-white">
      <div className="mx-auto max-w-2xl">
        ...
        {!loading && items.length === 0 && (
          <p className="mt-10 text-center text-sm text-white/50">No dishes in this category yet.</p>
        )}
          ...
          {items.map((food) => (
            <div key={food._id} className="overflow-hidden rounded-xl bg-surface">
              ...
              <div className="p-3">
                ...
                <p className="truncate text-xs text-white/50">{food.foodPartner?.name}</p>
